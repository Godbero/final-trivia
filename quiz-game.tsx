              ...
              <Card.Body>
                ...
                {gameState === 'playing' && (
                  <>
                    ...
                    <p className="lead text-center mb-4">{currentQuestion.question}</p>
                      ...
                      {currentQuestion.options.map((option, index) => (
                        <Button
                          ...
                          variant={selectedAnswer === index 
                            ? (index === currentQuestion.correctAnswer ? "success" : "danger") 
                            : "outline-primary"}
                    ...
                    {showFeedback && (
                      <Alert variant={selectedAnswer === currentQuestion.correctAnswer ? "success" : "danger"}>
                        <Alert.Heading>
                ...
                {gameState === 'results' && (
                  <div className="text-center">
                    ...
                    <p className="lead mb-4">Your final score: {score}/{quizQuestions.length}</p>
                    <p>
                    ...
                    <Button onClick={handleRestartGame} size="lg">Play Again</Button>
                  </div>
                )}
              </Card.Body>
            </Card>
